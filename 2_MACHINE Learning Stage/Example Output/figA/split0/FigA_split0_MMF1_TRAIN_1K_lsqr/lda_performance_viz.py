                ...
                for plot_type in ['roc', 'pr']:
                    ...
                    for i in range(len(le.classes_)):
                        ...
                        if plot_type == 'roc':
                            ...
                            line, = ax.plot(fpr, tpr, color=colors[i % len(colors)])
                            legend_lines.append(line)
                            legend_labels.append(f'{population} (AUC = {roc_auc:.2f})')
                            ...
                            metrics[population] = (precision, recall)
                            line, = ax.plot(recall, precision, color=colors[i % len(colors)])
                            legend_lines.append(line)
                            legend_labels.append(population)
